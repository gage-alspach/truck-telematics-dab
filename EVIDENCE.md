...
The history should include the table-creation, `active_flag`, and initial fleet seed migrations, plus the `truck_class` pre- and post-migrations on this branch after promotion.
